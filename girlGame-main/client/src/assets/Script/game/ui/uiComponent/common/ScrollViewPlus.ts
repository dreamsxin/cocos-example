...
export default class ScrollViewPlus extends cc.ScrollView {
    ...
    public optDc() {
        if (this.node_next != null) {
            if (this.horizontal)
                this.node_next.active = Math.abs(this.content.x) < this.getMaxScrollOffset().x;
            else
                this.node_next.active = Math.abs(this.content.y) < this.getMaxScrollOffset().y;

        }
        if (this.node_pre != null) {
            if (this.horizontal)
                this.node_pre.active = this.content.x < 0;
            else
                this.node_pre.active = this.content.y < 0;
        }
