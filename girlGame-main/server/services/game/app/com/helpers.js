...
class DataHelper
{
    static markInsert(doc)
    {
        doc['__v'] = SqlString.SQL_TYPES().INSERT;
        delete doc['__mainkey'];
    }
    static markDelete(doc)
    {
        doc['__v'] = SqlString.SQL_TYPES().DELETE;
        delete doc['__mainkey'];
    }
    static markUpdate(doc)
    {
