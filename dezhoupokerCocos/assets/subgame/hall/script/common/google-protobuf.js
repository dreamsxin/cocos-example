...
jspb.Message.initialize = function (a, b, c, d, e, f) {
    ...
    if (e)
        for (b = 0; b < e.length; b++) c = e[b], c < a.pivot_ ? (c = jspb.Message.getIndex_(a, c), a.array[c] = a.array[c] || (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? jspb.Message.EMPTY_LIST_SENTINEL_ : [])) : (jspb.Message.maybeInitEmptyExtensionObject_(a),
...
jspb.Exports = {};
jspb.Exports.Map = jspb.Map;
jspb.Exports.Message = jspb.Message;
jspb.Exports.BinaryReader = jspb.BinaryReader;
jspb.Exports.BinaryWriter = jspb.BinaryWriter;
jspb.Exports.ExtensionFieldInfo = jspb.ExtensionFieldInfo;
jspb.Exports.ExtensionFieldBinaryInfo = jspb.ExtensionFieldBinaryInfo;
jspb.Exports.exportSymbol = goog.exportSymbol;
jspb.Exports.inherits = goog.inherits;
jspb.Exports.object = {
    extend: goog.object.extend
};
jspb.Exports.typeOf = goog.typeOf;
