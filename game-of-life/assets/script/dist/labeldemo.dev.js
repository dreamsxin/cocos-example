...
cc.Class({
  ...
  onLoad: function onLoad() {
    console.log(this.node.name); //for (let i = 0; i < 80; i++) {

    var label = this.labelEmptyNode.addComponent(cc.Label);
    label.string = "325432ft";
    label.fontSize = 20;
    console.log(label);
    label.node.color = new cc.color(255, 255, 0, 255); //label.node.setPosition(cc.v2(100, 100))
    //}

    console.log(this.node); // let label = this.node.addComponent(cc.Label);
